...
function changeImage() {
    document.getElementById("portefeuille").src="./styles/sad-wallet.jpg";
}

function ReturnImage() {
    document.getElementById("portefeuille").src="./styles/happy-wallet.jpg";
...
btn_add_deps.addEventListener ("click", function () {
...
btn_add_revenu.addEventListener ("click", function () {
...
if(jour) {
var date = new Date();
date.setTime(date.getTime()+(jour*24*60*60*1000)); //expiration
var exp = '; exprires='+date.toGMTSTRING();
...
function setCookie(cname,cvalue,exdays) {
  ...
  function WriteCookie() {
    if( document.arrInputDep.customer.value == "" ) {
       alert("Enter some value!");
       return;
    }
    cookievalue = escape(document.arrInputDep.customer.value) + ";";
    document.cookie = "cname=" + cookievalue;
    document.write ("Setting Cookies : " + "cname=" + cookievalue );
 }
 ...
 function ReadCookie() {
    ...
    for(var i=0; i<cookiearray.length; i++) {
       ...
       document.write ("ssaa : " + cname + " aaaa: " + value);
    }
 }